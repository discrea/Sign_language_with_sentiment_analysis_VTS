...
def read_pose_file(filepath):
    ...
    save_to = os.path.join('/Users/san/work/python/Deep_Learning/Sign_language_with_sentiment_analysis_VTS/practice/Seok_Yong/WLASL-master/code/TGCN/pose/features', vid)
