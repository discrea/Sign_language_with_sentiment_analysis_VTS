...
def run(init_lr=0.1,
    ...
    print('top-k average per class acc: {}, {}, {}'.format(top1_per_class,
          top5_per_class, top10_per_class))
...
if __name__ == '__main__':
    ...
    weights = 'checkpoints/bs-1_lr-0.05/nslt_2000_052225_0.001190.pt'

    run(mode=mode, root=root, save_model=save_model,
